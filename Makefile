...
assignment_2: experiment_results_assignment2_part1.csv
...
fm_hg38_full.index: build/bin/fmindex_construct data/GCF_000001405.26_GRCh38_genomic.fna.gz
	build/bin/fmindex_construct --reference data/GCF_000001405.26_GRCh38_genomic.fna.gz --index fm_hg38_full.index
